...
public class _05_CreateOppWithOrgNameOrTypeBusiness {
...
//		***Save  The  Data   ****//
		...
		Thread.sleep(2000);
		/***
		 * Click on Save 'btn'***** Here 4 Type of Save Btn Are Available 2 Are Hidden
		 * ******* we use Xpath Two Way (1)By Surroundings (2)By Indexing
		 * (//input[@class='crmbutton small save'])[1]
		 ****/
...
//	####****      Now logout  The WebPage     ***#####
		...
		/*
		 * *** WEprofile to hover mouse We use Mouse Action Class To Hover The Mouse
		 * Cursor on the Particular Element moveToElement()
		 */
		 ...
		 */
		/*
		 * ****Sign Out*** Now We Click on the Sign Out
		 */
...
//		driver.findElement(By.linkText("Sign Out")).click();
		...
		Thread.sleep(2000);
		/*
		 * closing browser ***quit(); This Method Will Close All The Window Also
